lrcType: 3,
    audio: [{
        name: "A Fine Frenzy - Almost Lover.MP3",
        ...
        {
        name: "Against the Current - Legends Never Die.MP3",
        ...
        {
        name: "Akie秋绘 - なんでもないや 没什么大不了的（Cover：Radwimps）.MP3",
        ...
        {
        name: "Alan Walker Sabrina Carpenter Farruko - On My Way.MP3",
        ...
        {
        name: "Alec Benjamin - Let Me Down Slowly.mp3",
        ...
        {
        name: "Alec Benjamin - Outrunning Karma.mp3",
        ...
        {
        name: "Alec Benjamin Alessia Cara - Let Me Down Slowly.MP3",
        ...
        {
        name: "Anthem Lights - Best of 2017 Medley.MP3",
        ...
        {
        name: "Anthony Keyrouz Romy Wave - Something Just Like This.MP3",
        ...
        {
        name: "Avril Lavigne - Innocence.MP3",
        ...
        {
        name: "Bandari - Annie's Wonderland.flac",
        ...
        {
        name: "Basic Tape Lana Del Rey - Summertime Sadness (Basic Tape Remix).MP3",
        ...
        {
        name: "Bea Miller - Open Your Eyes (Deep Blue Songspell).MP3",
        ...
        {
        name: "Biscuits - i hate u i love u.MP3",
        ...
        {
        name: "Boyce Avenue Bea Miller - We Can't Stop.FLAC",
        ...
        {
        name: "Brian Tyler - Falling Into A Dream.MP3",
        ...
        {
        name: "Charlie Puth - Attention.MP3",
        ...
        {
        name: "Christina Grimmie - Without Him.MP3",
        ...
        {
        name: "Christine Welch - 一百万个可能.flac",
        ...
        {
        name: "Conor Maynard - Stitches.MP3",
        ...
        {
        name: "Conor Maynard Alex Aiono The Chainsmokers Halsey - Closer (Conor Maynard Cover).MP3",
        ...
        cover: "https://sharelist.honus.top/honus/music/image/Conor%20Maynard%20Alex%20Aiono%20The%20Chainsmokers%20Halsey%20-%20Closer%20%28Conor%20Maynard%20Cover%29.jpg",
        ...
        {
        name: "Cubi 多多Aydos - BINGBIAN病变（prod.jurrivh）.MP3",
        url: "https://sharelist.honus.top/honus/music/song/Cubi%20%E5%A4%9A%E5%A4%9AAydos%20-%20BINGBIAN%E7%97%85%E5%8F%98%EF%BC%88prodjurrivh%EF%BC%89.MP3",
        ...
        {
        name: "DAISHI DANCE Cecile Corbel - Take me hand.FLAC",
        ...
        {
        name: "Daley - Time Travel (Moonnight Remix).MP3",
        ...
        {
        name: "Deep Side - Booty Music.mp3",
        ...
        {
        name: "Diana Boncheva - Purple Passion.FLAC",
        ...
        {
        name: "DP龙猪 宝楽CNBALLER CLOUDWANG 王云 - 全部都是你.MP3",
        ...
        {
        name: "Ellie Goulding - Love Me Like You Do.flac",
        ...
        {
        name: "Eva The Heartmaker - Calling You.mp3",
        ...
        {
        name: "Feint Laura Brehm - We Won't Be Alone (feat. Laura Brehm).flac",
        ...
        {
        name: "Gareth Gates - With You All The Time.mp3",
        ...
        {
        name: "Groove Coverage - Far Away From Home.MP3",
        ...
        {
        name: "Jacoo - The Last String.FLAC",
        ...
        {
        name: "Justin Bieber Big Sean - As Long As You Love Me.MP3",
        ...
        {
        name: "Kazlo Alexa Lusader - Take Me Away.mp3",
        ...
        {
        name: "Luis Fonsi Daddy Yankee Justin Bieber - Despacito (Remix).MP3",
        ...
        {
        name: "M2M - The Day You Went Away.MP3",
        ...
        {
        name: "MADILYN - Dusk Till Dawn.MP3",
        ...
        {
        name: "MADILYN - Safe and Sound.FLAC",
        ...
        {
        name: "MADILYN Jake Coco - I Need Your Love.mp3",
        ...
        {
        name: "Maria Arredondo - Burning.flac",
        ...
        {
        name: "Melanie C - First Day Of My Life.mp3",
        ...
        {
        name: "Neru 鏡音リン 鏡音レン - 病名は愛だった.mp3",
        ...
        {
        name: "Owl City Breanne Düren - The Saltwater Room.mp3",
        ...
        {
        name: "Pianoboy高至豪 - The truth that you leave.MP3",
        ...
        {
        name: "PVRIS - Waking up (Acoustic).MP3",
        ...
        {
        name: "R3hab Taylor Swift - Wildest Dreams (R3hab Extended Remix).mp3",
        ...
        {
        name: "RADWIMPS - 前前前世 (movie ver.).flac",
        ...
        {
        name: "Sarah Brightman - Scarborough Fair.flac",
        ...
        {
        name: "Selena Gomez & The Scene - My Dilemma.flac",
        ...
        {
        name: "Shayne Ward - Breathless.flac",
        ...
        {
        name: "Shayne Ward - Until You.MP3",
        ...
        {
        name: "Taylor Swift - Back To December Apologize You're Not Sorry (Live 2011 Medley).flac",
        ...
        {
        name: "Taylor Swift The Civil Wars - Safe And Sound.MP3",
        ...
        {
        name: "The Glitch Mob Mako The Word Alive - RISE.MP3",
        ...
        {
        name: "The Spacies - Hesitate.FLAC",
        ...
        {
        name: "THE.A-OST - ☆THE.A★无冕之王（太难相处朴灿烈主题曲）（Cover 朴智敏）.MP3",
        ...
        {
        name: "Thomas Bergersen - Empire of Angels.MP3",
        ...
        {
        name: "Tiya Manson M R U O RED8红八 - 矛盾体.flac",
        ...
        {
        name: "Two Steps From Hell - Never Back Down.flac",
        ...
        {
        name: "Vigel Sartek - Only You.MP3",
        ...
        {
        name: "三无MarBlue - ツキアカリのミチシルベ（Cover stereopony）.MP3",
        ...
        {
        name: "何枫 - Cubi   Fi9江澈-HEAL ME（病变Remix）（HeFeng remix）.MP3",
        ...
        {
        name: "叶里 苑舍 - 葬仙-记狠人大帝（Cover 张杰）.MP3",
        ...
        {
        name: "哭笑不得得得颖儿 - 承欢殿( 灿白《承欢》OST）（Cover：香香）.MP3",
        ...
        {
        name: "哭笑不得得得颖儿 夹＿zZ - Please( 灿白《要命》OST）（Cover Skylar Grey）.FLAC",
        ...
        {
        name: "大白的菠萝包 - 因果（《魔道祖师》薛洋角色歌）（Cover 《地尽头》）.MP3",
        ...
        {
        name: "少年霜 Sol Ciel ShakingHigh - KOKIA-EXEC_COSMOFLIPS（四人唱见双声道 ShakingHigh Remix）（ShakingHigh 少年霜 Sol Ciel 毕啵腾 吉田亚纪子 Remix）.MP3",
        ...
        {
        name: "林鹿森 余半声 - 【余半声版】眉冬（Cover 地尽头）.MP3",
        ...
        {
        name: "永彬Ryan.B 周延英（英子-effie） - 没有理由.flac",
        ...
        {
        name: "祖娅纳惜 - 血腥爱情故事（Cover：Amit）.MP3",
        ...
        {
        name: "纱琉璃Shelley - 我的一个道姑朋友（Cover タイナカ彩智   Lon）.MP3",
        ...
        {
        name: "若以止白 - 魔道祖师-薛晓同人［草木］（Cover：三代目J Soul Brothers）.mp3",
        ...
        {
        name: "豆沙团子AnDango - 矢野立美 - 迪迦奥特曼 - LOVE Theme from TIGA.FLAC",
        ...
        {
        name: "轩寞 - 红尘轻剑—记【魔道祖师】忘羡 双道长 部分群像（Cover：松本恵奈）.MP3",
        ...
        {
        name: "阿YueYue - 橙光《末生》朴灿烈角色歌【等不及】（Cover Ailee）.MP3",
        ...
        {
        name: "陵易_Line 双笙 - 故梦 双声道 陵易 双笙（Cover 橙翼）.MP3",
        ...
        {
        name: "黑崎子 - Attention(Acoustic ver.)（Cover Charlie Puth）.mp3",
